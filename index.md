...
Note: The VMs in this network set up use Bridge mode for internet access, so they’re part of your 
       home network and not an isolated lab. If you want an isolated lab, wait until everything is set up, 
       then switch adapters to Host-only or Internal Network. You now have an attack machine, 
       target machine, and SIEM to monitor activity—feel free to tweak settings, modify SIEM 
       rules, and experiment. Don’t worry about breaking anything; you can always reinstall a VM. 
...
connectivity and isolation for safe experimentation.
To keep things organized, the guide is split into five parts:
• Part 1:	| pfSense VM Installation
• Part 2.a: 	| pfSense Network Configurations
• Part 2.b: 	| Kali Linux Network Configurations
• Part 2.c: 	| Ubuntu Wazuh Network Configurations
• Part 2.d:	| Windows 10 Network Configurations
 What We’ll Install
...
• The foundation for scaling the lab into more advanced SOC environments.
